    ...
    <div>
      <div className="thin">
        ...
        <div className="">
          ...
          <li>
            <span>The Governor, who heads the Executive Department, and Lieutenant Governor (who are elected on a joint ballot).</span>
          </li>
          <li>
            <span>The State Comptroller, who heads the Department of Audit and Control.</span>
          </li> 
          <li>
            <span>The Attorney General, who heads the Department of Law.</span> 
          </li>	
